...
class Table:
    ...
    def drop_columns(self, columns: Sequence[str | ArrowSchemaExportable]) -> Table:
        """Create a new Table with the `columns` removed. An empty input does not remove any column

        Args:
            columns: The columns to drop, case-sensitive.

        Returns:
            A new table without the columns.

        Raises:
            ValueError: if any given column does not exist in the table.
        """
        pass
