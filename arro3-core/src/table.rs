...
impl From<Arro3Table> for PyTable {
    fn from(value: Arro3Table) -> Self {
        Self::new(value.batches, value.schema)
    }
}

impl From<&Arro3Table> for PyTable {
    fn from(value: &Arro3Table) -> Self {
        Self::new(value.batches.clone(), value.schema.clone())
    }
}
...
impl Arro3Table {
    ...
    pub fn __eq__(&self, other: &Arro3Table) -> bool {
    ...
    pub fn from_arrow_pycapsule(
        ...
        PyTable::from_arrow_pycapsule(capsule).into()
    }
